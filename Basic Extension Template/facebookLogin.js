...
window.onload = function() {
	...
	document.getElementById("Get").onclick = function() {
		...
		chrome.storage.sync.get("accessToken", function(item) {
			...
			httpGetAsync("https://graph.facebook.com/me?fields=id,cover,first_name,last_name,age_range,gender,email,work,education&access_token="+item.accessToken, jsonParse);
		});
